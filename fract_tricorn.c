...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/14 19:17:48 by mhedeon           #+#    #+#             */
/*   Updated: 2018/08/20 17:13:51 by mhedeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_tricorn(t_mlx *mlx, t_fract *fract)
{
	...
	fract->color = 3;
	mlx->help = -1;
	good_zoom(fract, 0.6, WIN_WIDTH / 2, WIN_HEIGHT / 2);
}

static int		t_itter(t_fract *fract, t_z *z)
{
	int			i;
	double		tmp_re;
	double		tmp_im;
