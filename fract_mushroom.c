...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/14 17:46:12 by mhedeon           #+#    #+#             */
/*   Updated: 2018/08/20 17:13:32 by mhedeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_mushroom(t_mlx *mlx, t_fract *fract)
{
	...
	fract->color = 1;
	mlx->help = -1;
	good_zoom(fract, 0.75, WIN_WIDTH / 2, WIN_HEIGHT / 2);
}
...
static void		mushroom(t_mlx *mlx)
{
	int			x;
	int			y;
	int			start;
